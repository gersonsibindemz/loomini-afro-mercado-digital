...
const CourseCreation = () => {
  ...
  const [newLesson, setNewLesson] = useState<{ [moduleId: string]: Partial<Lesson> }>({});
  const [newMaterial, setNewMaterial] = useState<{ [moduleId: string]: string }>({});
  ...
  const addMaterial = (moduleId: string) => {
    ...
    setNewMaterial(prev => ({ ...prev, [moduleId]: '' }));
  };
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          {...field}
                          placeholder="Resumo em uma linha do seu curso"
                          className="loomini-input"
                        />
                      </FormControl>
                      <FormMessage />
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <textarea
                          {...field}
                          placeholder="Descreva os resultados de aprendizagem e habilidades que os alunos desenvolverão..."
                            ...
                            <div className="bg-gray-50 rounded-lg p-4 space-y-4">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <Input
                                  ...
                                  value={newLesson[module.id]?.title || ''}
                                ...
                                <Input
                                  ...
                                  value={newLesson[module.id]?.duration || ''}
                                  onChange={(e) => setNewLesson(prev => ({
                                    ...prev,
                                    [module.id]: { ...prev[module.id], duration: e.target.value }
                                  }))}
                                />
                                <Input
                                  placeholder="URL do Vídeo (opcional)"
                                  value={newLesson[module.id]?.videoUrl || ''}
                                  onChange={(e) => setNewLesson(prev => ({
                                    ...prev,
                                ...
                                <Input
                                  ...
                                  value={newLesson[module.id]?.description || ''}
                                  onChange={(e) => setNewLesson(prev => ({
                                    ...prev,
                              ...
                              <Button 
                                ...
                                disabled={!newLesson[module.id]?.title || !newLesson[module.id]?.duration}
                                size="sm"
                                className="loomini-button"
                              >
                              ...
                              <div>
                                ...
                                <div className="space-y-2">
                                  {module.lessons.map((lesson, lessonIndex) => (
                                    <div key={lesson.id} className="flex items-center justify-between bg-white p-3 rounded border">
                                      <div className="flex items-center space-x-3">
                            ...
                            <div className="bg-gray-50 rounded-lg p-4 space-y-4">
                              ...
                              <div className="flex space-x-3">
                                ...
                                <Button 
                                  ...
                                  disabled={!newMaterial[module.id]?.trim()}
                                  size="sm"
                                  className="loomini-button"
                                >
                                  Adicionar Material
