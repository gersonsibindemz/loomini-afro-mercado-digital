...
const Home = () => {
  ...
  const categories = [
    { name: "Cursos Online", count: 234, icon: "📚" },
    { name: "E-books", count: 456, icon: "📖" },
    { name: "Templates", count: 123, icon: "🎨" },
    { name: "Software", count: 67, icon: "💻" },
    { name: "Música", count: 89, icon: "🎵" },
    { name: "Videos", count: 145, icon: "🎬" }
  ];

  const stats = [
    { number: "10K+", label: "Produtos Digitais", icon: "📦" },
    { number: "5K+", label: "Criadores Ativos", icon: "👥" },
    { number: "25K+", label: "Vendas Realizadas", icon: "💰" },
      ...
      <section className="loomini-gradient text-white py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 animate-fade-in">
            <Link 
              to="/register" 
              className="bg-white text-loomini-blue px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-50 transition-all duration-200 shadow-lg"
            >
              Começar a Vender
            </Link>
            <Link 
              to="/produtos" 
              className="border-2 border-white text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-white hover:text-loomini-blue transition-all duration-200"
            >
              Explorar Produtos
            </Link>
          </div>
      ...
      <section className="py-16 bg-loomini-gradient-light">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mt-12">
            <Link 
              to="/produtos" 
              className="loomini-button inline-flex items-center space-x-2"
            >
            ...
            {categories.map((category, index) => (
              ...
              >
                <div className="p-6">
                  ...
                  <h3 className="font-semibold text-loomini-dark mb-1 group-hover:text-loomini-blue transition-colors duration-200">
                    {category.name}
                  </h3>
      ...
      <section className="py-20 loomini-gradient text-white">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              to="/cadastro-produto" 
              className="bg-white text-loomini-blue px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-50 transition-all duration-200 shadow-lg inline-flex items-center justify-center space-x-2"
            >
